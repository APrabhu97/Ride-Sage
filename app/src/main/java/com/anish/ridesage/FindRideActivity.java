...
public class FindRideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destination = (EditText) findViewById(R.id.findRideDestination);
                ...
                Places.initialize(getApplicationContext(), getString(R.string.com_google_android_geo_API_KEY));
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d("BookRideActivity", "Current location is null. Using defaults.");
                            Log.e("BookRideActivity", "Exception: %s", task.getException());
